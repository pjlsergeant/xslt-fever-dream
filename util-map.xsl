...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    <!--
        ...
        attributes for performance), but that meant that I couldn't store complex values. Except
        for the idiom of using "/.." as a known empty nodeset (which I found with a quick Google),
        this is entirely my own work, inspired by the stack mechanism I built for the expression
        evaluator in the class exercises.
